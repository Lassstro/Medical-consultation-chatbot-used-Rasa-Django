...
class TrichThongTin(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        form_bhyt = f"Hãy xác nhận thông tin: Mã thẻ BHYT: {info['ma_so_BHYT']}, Họ và tên: {info['ho_ten']}, Ngày sinh: {info['ngay_sinh']}, Giới tính: {info['gioi_tinh']}, Địa chỉ: {info['dia_chi']}"
